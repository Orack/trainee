...
$job_title		= array('id'=>'job_title', 'class'=>'form-control', 'name'=>'job_title', 'placeholder'=>'Job Title' ,'value'=> set_value('job_title'));
$description	= array('id'=>'description', 'class'=>'form-control', 'name'=>'description', 'placeholder'=>'Description', 'value'=>set_value('description'));
$city			= array('id'=>'city', 'class'=>'form-control', 'name'=>'city', 'placeholder'=>'City', 'value'=>set_value('city'));
$zipcode		= array('id'=>'zipcode', 'class'=>'form-control', 'name'=>'zipcode', 'placeholder'=>'Zip Code', 'value'=>set_value('zipcode'));
...
<div class="spacer-1">&nbsp;</div>
	<div class="row">
		<div class="col-md-8">
				...
				<?php echo form_open('search/post_job', 'role="form"', 'class="form-inline post-job-form"'); ?>
				...
				<div class="form-group">
					<input type="submit" value="POST A JOB" class="btn btn-default btn-green">					
				</div>
			</form>
		...
		<div class="col-md-4">
			...
			<div class="job-side-wrap">
				...
				<p class="centering"><a href="<?php echo site_url('manage_application')?>" class="btn btn-default btn-green">Manage</a></p>				
			</div>
