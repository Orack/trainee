...
<!-- Generic page styles -->
<link type="text/css" href="<?php echo base_url('assets/css/upload/style.css');?>" rel="stylesheet" />
...
<link type="text/css" href="<?php echo base_url('assets/css/upload/jquery.fileupload-ui.css');?>" rel="stylesheet" />
<!-- CSS adjustments for browsers with JavaScript disabled -->


<link type="text/css" href="<?php echo base_url('assets/css/upload/jquery.fileupload-noscript.css');?>" rel="stylesheet" />
<link type="text/css" href="<?php echo base_url('assets/css/upload/jquery.fileupload-ui-noscript.css');?>" rel="stylesheet" />
<!-- The file upload form used as target for the file upload widget -->
<?php echo form_open_multipart('upload/upload/do_upload/',  'id="fileupload"'); ?>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/upload/jquery.fileupload-ui.js');?>"></script>
<!-- The main application script -->
<script type="text/javascript" src="<?php echo base_url('assets/js/upload/main.js');?>"></script>
